...
const Home = () => {
  ...
  return (
    <div style={{ display: "flex" }}>
      ...
      >
        {
          userRole == 'Admin' && <img src={Profile_Pic}></img>
        }
        {
          userRole == 'Student' && <img src={CN1}></img>
        }
        <div class="flex items-center px-6 py-3 bg-gray-900">
          ...
          <h1 class="mx-3 text-lg font-semibold text-white">{userRole}</h1>
        </div>
        ...
        <div class="px-6 py-4">
          ...
          <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 class="px-2 text-sm">(312) 987-8729</h1>
          </div>
          <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            <svg
              class="h-6 w-6"
          ...
          <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 class="px-2 text-sm">ikattabalaji@hawk.iit.edu</h1>
          </div>
        </div>
      </div>
      <div style={{ display: "banner" }}>
        <div
          style={{ marginRight: "65px", marginTop: "40px" }}
          class="max-w-2xl px-8 py-4 bg-white rounded-lg shadow-md dark:bg-gray-800"
        >
          <span class="text-lg font-bold text-black-600 dark:text-black-400">
            GPA per Subject
          </span>
          ...
          <table class="table-auto w-full bg-white shadow rounded">
            ...
            <tbody>
              ...
              <tr class="text-s border-b border-gray-100">
                <td class="pl-4 py-4 bg-blue-50">Graduate Assistant Program</td>
